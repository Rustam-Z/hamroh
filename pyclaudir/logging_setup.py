...
object per line to ``<data_dir>/logs/pyclaudir.log`` (rotated daily, 7 days
...
def _component(logger_name: str) -> str:
    ...
    if logger_name == "pyclaudir":
        return "core"
    name = logger_name.removeprefix("pyclaudir.")
